...
# ----------------------------------------------------------------------
alpha3   = 0.19  # (mol CO2abs)/(mol amine (MEA))  CO2 loading into absorber
...
# inlet conditions
# -----------------------------------------------------------------------
m1    = 650    # kg/s       mass flow (total), stream 1
wc1   = 0.14   # -          mass fraction CO2, stream 1
wh1   = 0.03   # -          mass fraction H2O, stream 1
wn1   = 0.745  # -          mass fraction N2,  stream 1
...
T[3]  = 45     # degC       stream 4
T[4]  = 109    # degC       stream 5
