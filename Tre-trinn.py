...
Ws_rev1 = mb.m9*(c.cpg[0]*1000)*(T_ut1-T_inn1)
Ws_real1 = Ws_rev1/c.eta
To_real1 = T_ut1+(Ws_real1/(mb.m9*(c.cpg[0]*1000)))
Q_kjoler1 = mb.m9*(c.cpg[0]*1000)*(T_inn1-To_real1)
...
Ws_rev2 = mb.m9*(c.cpg[0]*1000)*(T_ut2-T_inn2)
Ws_real2 = Ws_rev2/c.eta
To_real2 = T_ut2+(Ws_real2/(mb.m9*(c.cpg[0]*1000)))
Q_kjoler2 = mb.m9*(c.cpg[0]*1000)*(T_inn2-To_real2)
...
Ws_rev3 = mb.m9*(c.cpg[0]*1000)*(T_ut3-T_inn3)
Ws_real3 = Ws_rev3/c.eta
To_real3 = T_ut3+(Ws_real3/(mb.m9*(c.cpg[0]*1000)))
Q_kjoler3 = mb.m9*(c.cpg[0]*1000)*(T_inn3-To_real3)
